            ...
            <div class = "col-md-4 mx-auto">
               <form id="register">
                  ...
                  <div class="mb-3">
                     ...
                     <textarea class="form-control" placeholder="Leave a comment here" id="emergencia" style="height: 100px"></textarea>
                  </div>
                  <div class="mb-3">
                     <label for="floatingTextarea2">Historial Clinico</label>
                     <textarea class="form-control" placeholder="Leave a comment here" id="historial" style="height: 100px"></textarea>
                  </div>
